...
cookieBanner.innerHTML = '<div id="cookieNotify"><span class="v5-span-heading1">Cookies on HSE website</span><p>We use necessary cookies to make our website work. We also use cookies to collect information about how you use HSE.gov.uk so we can improve our services. You can visit our <a href="https://www.hse.gov.uk/privacy-cookies.htm">cookie privacy page</a> for more information.</p><button id="acceptAllCookies">Hide message</button></div>',

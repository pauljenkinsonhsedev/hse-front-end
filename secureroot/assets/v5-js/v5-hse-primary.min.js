...
if (!cookieExists) {	
	Cookies.set(cookiePolicy, encodedEssential , { path: '/' , sameSite: 'None', secure: true, expires: 365})
}
...
$('#acceptAllCookies').click(function() {
 ...
 Cookies.set(cookiePolicy, encodedApproved , { path: '/', sameSite: 'None', secure: true,  expires: 365})

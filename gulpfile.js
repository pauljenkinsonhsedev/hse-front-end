...
var paths = {
  ...
  srcJSV5: ['src/assets/v5-js/v5-footer.min.js', 'src/assets/v5-js/cookies-gtm.js', 'src/assets/v5-js/v5-hse-primary.min.js', 'src/assets/v5-js/gtm.js', 'src/assets/v5-js/v5-footer-slinky-js.min.js', 'src/assets/v5-js/cookie-preferences.js', 'src/assets/v5-js/js-main-menu.js' ],
...
gulp.task('footer-js', function () {    
  ...
  return gulp.src(['./src/assets/v5-js/google-custom-search.js','src/assets/v5-js/js-cookie.js','./src/assets/v5-js/base64-poly.js', './src/assets/v5-js/js-main-menu.js','./src/assets/v5-js/v5-hse-primary.min.js','./src/assets/v5-js/slinky-ie11-fix.js', './src/assets/v5-js/aria.js', './src/assets/v5-js/website-feedback.src.js', './src/assets/v5-js/content-page.js', './src/assets/v5-js/notification-bar.js', './src/assets/v5-js/top-tasks.js', './src/assets/v5-js/cookies-gtm.js'])

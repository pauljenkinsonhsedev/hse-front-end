...
var paths = {
  ...
  srcJSV5: ['src/assets/v5-js/jquery.min.js','src/assets/v5-js/v5-footer.min.js', 'src/assets/v5-js/v5-footer-slinky-js.min.js', 'src/assets/v5-js/hse-secondary.min.js', 'src/assets/v5-js/hse-tables.min.js', 'src/assets/v5-js/hse-lightbox.min.js' ],

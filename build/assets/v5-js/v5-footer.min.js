...
cookieBanner.innerHTML = '<div id="cookieNotify"><span class="v5-span-heading1">Cookies on HSE website</span><p>We use necessary cookies to make our website work. We also use cookies to collect information about how you use HSE.gov.uk so we can improve our services.</p><div class="v5-inline"><div class="v5-button"><a id="acceptAllCookies" href="#">Accept all cookies</a></div></div><div class="v5-inline"><div class="v5-button"><a href="../cookies.htm">Cookies on HSE website</a></div></div></div>',
...
$('#acceptAllCookies').click(function() {
	...
	$("#cookieNotify").empty().append('<p>You can visit our <a href="https://www.hse.gov.uk/privacy-cookies.htm">cookie privacy page</a> for more information.</p> <button class="v5-hide-button v5-float-right v5-close">Hide</button>');

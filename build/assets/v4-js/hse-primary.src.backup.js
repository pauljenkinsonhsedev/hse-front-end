...
/**
* Dropdown menus switch
* Create the HTML of the share box, and insert it into the container div (see Dev guide)
* turns:

	<ul class="ddmswitch anyOtherClass" id="si" title="Label text appropriate to dropdown">
		<li><a href="../page/url_with_default_class.htm" class="default">All pages - label appropriate to UL</a></li>
		<li><a href="../page/one.htm">Page title 1</a></li>
		<li><a href="../page/two.htm">Page title 2</a></li>
    </ul>
	into XHTML Strict compliant form dropdown: 
	<form action="#" class="ddmswitch anyOtherClass">
		<fieldset>
			<label class="hidden" for="si">Label text appropriate to dropdown</label>
			<select id="si">
				<option value="../page/url_with_default_class.htm">Label text appropriate to dropdown</option>
				<option value="../page/one.htm">Page title 1</option>
				<option value="../page/two.htm">Page title 2</option>
			</select>
			<input type="submit" value="Go" class="button"/>
		</fieldset>
	</form>

	and makes correct option select if appropriate

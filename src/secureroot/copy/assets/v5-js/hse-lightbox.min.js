/* v4.2.7 */
function hse_lightbox_init(){$("a.lightbox:not(.noProgressiveEnhancement)").removeClass("lightbox").wrap('<div class="lightbox"></div>');$(".lightbox:not(.noProgressiveEnhancement)").each(function(){var g=$(this);g.find("a").not($(".download a, a.download")).each(function(){var a=$(this);if(""==a.attr("title")){var b=a.find("img[title]:first").attr("title");void 0!=b?a.attr("title",b):(b=a.find("img[alt]:first").attr("alt"),void 0!=b?a.attr("title",b):(b=a.text(),void 0!=b&&a.attr("title",b)))}}).nyroModal({hideContent:function(a,
b,d){a.contentWrapper.hide("fast",a.contentWrapper.hide(),d())},minHeight:150,addImageDivTitle:!0,closeButton:'<a href="#" class="nyroModalClose" id="closeBut" title="Close - escape key">Close</a>',galleryLinks:'<a href="#" class="nyroModalPrev" title="Previous - left arrow key">Previous</a><a href="#"  class="nyroModalNext" title="Next - right arrow key">Next</a>',galleryCounts:function(a,b,d,c){c.title+=' <span class="nyroModalCount">('+a+" of "+b+")</span>"},endFillContent:function(a,b){$("div#nyroModalContent div").hide()},
debug:!1,endShowContent:function(a,b){var d=$("div#nyroModalContent div"),c=d.height(),e=parseInt(a.content.css("padding-bottom"));c<e&&d.css("margin-bottom",Math.round((e-c)/2)+"px");c>e&&(e=c-e,a.content.css("padding-bottom",c+10+"px"),a.contentWrapper.css("height",parseInt(a.contentWrapper.css("height"))+e+10+"px"),d.css("margin-bottom","5px"));$("div#nyroModalContent div").fadeIn("fast")}});if("ul"==this.tagName.toLowerCase()){var h=g.width(),f=0,k=1;g.find("li").each(function(a){a=$(this);var b=
a.find("img:first").width();a.width(0==b?"150px":b);b=a.width();f+b+0<=h?(f+b+0+20<=h&&a.css("padding-right","20px"),a.css("padding-left","0px")):(k++,f=0,a.css("padding-left","0px"),a.css("padding-right","20px"));f+=b+0+20;a.addClass("equalHeight"+k)})}})}$(".lightbox img").after('<div class="expand"></div>');var imageHeight=$(".lightbox img").height(),imageWidth=$(".lightbox img").width();$(".lightbox .expand").css("top",imageHeight-27+"px");$(".lightbox .expand").css("left",imageWidth-27+"px");
// --------------------------------------

/* http://plugins.jquery.com/project/mousewheel
* Version: 3.0.2
* HSE: Included for nyroModal, to catch scroll events while gallery is being shown
*/

...
// Cookie preferences (hse.gov.uk/cookies.htm)
	...
	// //  $("#cookieNotify").empty().append('<p>You can visit our <a href="../cookie-privacy.htm">cookie privacy page</a> for more information.</p> <button class="btn btn-red v5-float-right v5-close">Hide</button>');

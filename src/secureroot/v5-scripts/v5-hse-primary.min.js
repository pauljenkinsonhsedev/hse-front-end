...
// Cookie preferences (hse.gov.uk/cookies.htm)
	...
	if (!cookieExists) {
		Cookies.set(cookiePolicy, encodedEssential , { path: '/' , domain: 'local', secure: false, expires: 365})
	}
	...
	$('#acceptAllCookies').click(function() {
	 ...
	 Cookies.set(cookiePolicy, encodedApproved , { path: '/', domain: 'local', secure: false,  expires: 365})

	 Cookies.set(cookiePreferences, true , { path: '/', domain: 'local', secure: false, expires: 365})
	...
	$('#rejectAllCookies').click(function() {
	 ...
	 Cookies.set(cookiePolicy, encodedRejected , { path: '/', domain: 'local', secure: false,  expires: 365})

	 Cookies.set(cookiePreferences, false , { path: '/', domain: 'local', secure: false, expires: 365})
	});

    ...
    var a = function() {
        ...
        return s(e, [{
            ...
            value: function(e) {
                ...
                var t = this.menu,
                    n = this.settings;
                t.addClass("slinky-menu").addClass(n.theme), this._transition(n.speed), jQuery("a + ul", t).prev().addClass("next"), jQuery("li > a", t);
            ...
            value: function() {
                ...
                jQuery(".header", n).remove(), jQuery("a", n).removeClass("next").off("click"), n.css({
                    ...
                    left: "",
                    "transition-duration": ""
                }), jQuery("li > a", n).contents().unwrap(), n.find(".active").removeClass("active"), n.attr("class").split(" ").forEach(function(e) {
  ...
  // Set active state
    ...
    $(".slinky-menu ul li a").each(function () {
      if ($(this).attr("href") == urlnew) {
        ...
        $(this).parent().addClass("active-page-parent");
   ...
   $(function() {
    ...
    var overviewTitle = $(element).parent().parent().find('a').first().text();
...
$(".slinky-menu ul li a").each(function () {
    ...
    $(this).wrapInner("<span class='text-width'>" + '</span>');
   
   });
   
   $( ".text-width" ).each(function() {
   
     var heightValue = $( this ).height();
   
     if (heightValue == 40) { 
     $('.slinky-menu').css( "height", "+=20px" );
     }

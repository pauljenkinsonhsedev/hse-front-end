...
function hse_sortable_tables_init(){var b=$("table.tablesortable, table.sortable");if(b.length){var a=function(){$("div.sortDirArrow").remove();$("th.tablesorter-headerAsc").prepend('<div class="sortDirArrow sortUp"></div>');$("th.tablesorter-headerDesc").prepend('<div class="sortDirArrow sortDown"></div>');$("th.tablesorter-header:not(.tablesorter-headerAsc):not(.tablesorter-headerDesc)").prepend('<div class="sortDirArrow sortNone"></div>')};b.find("th").css("cursor","pointer");b.tablesorter().bind("sortEnd",
$("body").data("settings").striped_tables.ready).bind("sortEnd",a);$.browser.msie&&8>=$.browser.majorVersion&&$("th.header").each(function(){var a=$(this);a.width(a.width()+18)});a()}}
function hse_expandable_tables_init(){$("table:has(tbody):not(.noProgressiveEnhancement):not(.noExpanding)").filter(function(){return 1<$(this).find("tbody").length}).each(function(){$(this).find("tbody").each(function(b){var a=$(this);b=function(b){if(void 0==b.keyCode||0==b.keyCode||13==b.keyCode)$(this).toggleClass("tableRowToggleClosed"),$(this).hasClass("tableRowToggleClosed")?a.find("tr:gt(0)").hide():a.find("tr:gt(0)").show(),b.preventDefault()};1<a.find("tr:not(.noProgressiveEnhancement):not(.noExpanding)").length&&
!a.hasClass(".noProgressiveEnhancement")&&!a.hasClass(".noExpanding")&&a.find("tr:first").find("td, th").eq(0).append($(' <a class="tableRowToggle" tabindex="0">Open/close</a> ').bind("click keypress",b).trigger("click"))})})}function hse_striped_tables(){var b=0;$("table:not(.noStripes) tr").each(function(){var a=$(this);0<a.find("td").length&&(a.removeClass("odd even").addClass(b%2?"odd":"even"),b++)})};
// --------------------------------------
/*!

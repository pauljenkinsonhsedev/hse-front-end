...
function hse_sortable_tables_init() {
    var b = $("table.tablesortable, table.sortable");
    if (b.length) {
        var a = function() {
            $("div.sortDirArrow").remove();
            $("th.tablesorter-headerAsc").prepend('<div class="sortDirArrow sortUp"></div>');
            $("th.tablesorter-headerDesc").prepend('<div class="sortDirArrow sortDown"></div>');
            $("th.tablesorter-header:not(.tablesorter-headerAsc):not(.tablesorter-headerDesc)").prepend('<div class="sortDirArrow sortNone"></div>')
        };
        b.find("th").css("cursor", "pointer");
        b.tablesorter().bind("sortEnd",
            $("body").data("settings").striped_tables.ready).bind("sortEnd", a);
        $.browser.msie && 8 >= $.browser.majorVersion && $("th.header").each(function() {
            var a = $(this);
            a.width(a.width() + 18)
        });
        a()
...
function hse_expandable_tables_init() {
    $("table:has(tbody):not(.noProgressiveEnhancement):not(.noExpanding)").filter(function() {
        return 1 < $(this).find("tbody").length
    }).each(function() {
        $(this).find("tbody").each(function(b) {
            var a = $(this);
            b = function(b) {
                if (void 0 == b.keyCode || 0 == b.keyCode || 13 == b.keyCode) $(this).toggleClass("tableRowToggleClosed"), $(this).hasClass("tableRowToggleClosed") ? a.find("tr:gt(0)").hide() : a.find("tr:gt(0)").show(), b.preventDefault()
            };
            1 < a.find("tr:not(.noProgressiveEnhancement):not(.noExpanding)").length &&
                !a.hasClass(".noProgressiveEnhancement") && !a.hasClass(".noExpanding") && a.find("tr:first").find("td, th").eq(0).append($(' <a class="tableRowToggle" tabindex="0">Open/close</a> ').bind("click keypress", b).trigger("click"))
        })
    })
}
...
! function(g) {
        ...
        tablesorter: new function() {
            ...
            function p(a, b, c) {
                ...
                var h = a.config,
                    e = h.textExtraction,
                    f = "",
                    f = "simple" === e ? h.supportsTextContent ? b.textContent : g(b).text() : "function" === typeof e ? e(b, a, c) : "object" === typeof e && e.hasOwnProperty(c) ? e[c](b, a, c) : h.supportsTextContent ? b.textContent : g(b).text();
                return g.trim(f)
            }

            function s(a) {
                var b = a.config,
                    c = b.$tbodies = b.$table.children("tbody:not(." + b.cssInfoBlock + ")"),
                    h, e, w, k, n, g, l, z = "";
                if (0 === c.length) return b.debug ? d("Warning: *Empty table!* Not building a parser cache") : "";
                ...
                if (c[0])
                    for (h = [], e = c[0].cells.length, w = 0; w < e; w++) {
                        ...
                        if (!g) a: {
                            k = a;n = c;g = -1;
                            for (var m = w, y = void 0, x = f.parsers.length, r = !1, s = "", y = !0;
                                "" === s && y;) g++,
                            n[g] ? (r = n[g].cells[m], s = p(k, r, m), k.config.debug && d("Checking if value was empty on row " + g + ", column: " + m + ': "' + s + '"')) : y = !1;
                            for (; 0 <= --x;)
                ...
                b.debug && (d(z), u("Completed detecting parsers", l));
                b.parsers = h
            }
            ...
            function v(a) {
                var b = a.tBodies,
                    ...
                    k, n, q, l, z, m, y, x = [];
                c.cache = {};
                if (!w) return c.debug ? d("Warning: *Empty table!* Not building a cache") : "";
                c.debug && (y = new Date);
                ...
                for (l = 0; l < b.length; l++)
                    if (c.cache[l] = {
                            row: [],
                            normalized: []
                        }, !g(b[l]).hasClass(c.cssInfoBlock)) {
                        h = b[l] && b[l].rows.length || 0;
                        e = b[l].rows[0] && b[l].rows[0].cells.length || 0;
                        for (n = 0; n < h; ++n)
                            if (z = g(b[l].rows[n]), m = [], z.hasClass(c.cssChildRow)) c.cache[l].row[c.cache[l].row.length - 1] = c.cache[l].row[c.cache[l].row.length - 1].add(z);
                            else {
                                c.cache[l].row.push(z);
                                for (q = 0; q < e; ++q) k = p(a, z[0].cells[q], q), k = w[q].format(k, a, z[0].cells[q], q), m.push(k), "numeric" === (w[q].type || "").toLowerCase() && (x[q] = Math.max(Math.abs(k) || 0, x[q] || 0));
                ...
                c.debug && u("Building cache for " + h + " rows", y)
            }
            ...
            function A(a, b) {
                var c = a.config,
                    ...
                    w = [],
                    k = c.cache,
                    d, q, l, z, p, y, x, r, s, t, v;
                if (m(k)) return c.appender ? c.appender(a, w) : "";
                c.debug && (v = new Date);
                for (r = 0; r < e.length; r++)
                    if (d = g(e[r]), d.length && !d.hasClass(c.cssInfoBlock)) {
                        p = f.processTbody(a, d, !0);
                        d = k[r].row;
                        q = k[r].normalized;
                        z = (l = q.length) ? q[0].length - 1 : 0;
                        for (y = 0; y < l; y++)
                            if (t = q[y][z], w.push(d[t]), !c.appender || c.pager && !(c.pager.removeRows && h.pager_removeRows || c.pager.ajax))
                                for (s = d[t].length, x = 0; x < s; x++) p.append(d[t][x]);
                        f.processTbody(a, p, !1)
                    }
                c.appender && c.appender(a, w);
                c.debug && u("Rebuilt table", v);
            ...
            function D(a) {
                ...
                for (f = 0; f < e.length; f++)
                    for (l = e[f].cells, d = 0; d < l.length; d++) {
                        ...
                        for (n = m; n < m + p; n++)
                            for ("undefined" === typeof b[n] && (b[n] = []), u = b[n], q = r; q < r + s; q++) u[q] = "x"
                    }
            ...
            function E(a) {
                ...
                l.$headers = g(a).find(l.selectorHeaders).each(function(a) {
                    ...
                    l.headerList[a] = this;
                    h.parent().addClass(f.css.headerRow + " " + l.cssHeaderRow);
                    l.tabIndex && h.attr("tabindex", 0)
                }).attr({
                    scope: "col"
                });
                G(a);
                l.debug && (u("Built headers:", q), d(l.$headers))
            }
            ...
            function F(a) {
                var b, c, h, e = a.config,
                    d = e.sortList,
                    k = f.css.sortNone + " " + e.cssNone,
                    n = [f.css.sortAsc + " " + e.cssAsc, f.css.sortDesc + " " + e.cssDesc],
                    q = ["ascending", "descending"],
                    l = g(a).find("tfoot tr").children().removeClass(n.join(" "));
                ...
                for (b = 0; b < h; b++)
                    if (2 !== d[b][1] && (a = e.$headers.not(".sorter-false").filter('[data-column="' + d[b][0] + '"]' + (1 === h ? ":last" : "")), a.length))
                        for (c = 0; c < a.length; c++) a[c].sortDisabled || (a.eq(c).removeClass(k).addClass(n[d[b][1]]).attr("aria-sort", q[d[b][1]]), l.length && l.filter('[data-column="' + d[b][0] + '"]').eq(c).addClass(n[d[b][1]]));
                e.$headers.not(".sorter-false").each(function() {
                    var a = g(this),
                        b = this.order[(this.count + 1) % (e.sortReset ? 3 : 2)],
            ...
            function M(a, b) {
                var c, h, e, f = a.config,
                    d = b || f.sortList;
                f.sortList = [];
                g.each(d, function(a, b) {
                    c = [parseInt(b[0], 10), parseInt(b[1], 10)];
                    if (e = f.$headers[c[0]]) f.sortList.push(c), h = g.inArray(c[1], e.order), e.count = 0 <= h ? h : c[1] % (f.sortReset ? 3 : 2)
                })
            }
            ...
            function O(a, b, c) {
                var h, e, d, k = a.config,
                    n = !c[k.sortMultiSortKey],
                    q = g(a);
                q.trigger("sortStart", a);
                ...
                if (n) {
                    ...
                    if (2 > h && (k.sortList.push([e, h]), 1 < b.colSpan))
                        for (c = 1; c < b.colSpan; c++) k.sortList.push([e + c, h])
                } else if (k.sortAppend && 1 < k.sortList.length && f.isValueInArray(k.sortAppend[0][0], k.sortList) && k.sortList.pop(), f.isValueInArray(e, k.sortList))
                    for (c = 0; c < k.sortList.length; c++) d = k.sortList[c], h = k.$headers[d[0]], d[0] === e && (d[1] = h.order[b.count], 2 === d[1] && (k.sortList.splice(c, 1), h.count = -1));
            ...
            function I(a) {
                var b, c, h, e, d, k, g, q, l, p, s, t, x = 0,
                    r = a.config,
                    v = r.textSorter || "",
                    A = r.sortList,
                    B = A.length,
                ...
                if (!r.serverSideSorting && !m(r.cache)) {
                    r.debug && (l = new Date);
                    for (c = 0; c < C; c++) d = r.cache[c].colMax, q = (k = r.cache[c].normalized) && k[0] ? k[0].length - 1 : 0, k.sort(function(c, k) {
                        for (b = 0; b < B; b++) {
                            e = A[b][0];
                            g = A[b][1];
                            x = 0 === g;
                            if (r.sortStable && c[e] === k[e] && 1 === B) break;
                    ...
                    r.debug && u("Sorting on " + A.toString() + " and dir " + g + " time", l)
                }
            }

            function J(a, b) {
                var c = a[0].config;
                c.pager && !c.pager.ajax && a.trigger("updateComplete");
                "function" === typeof b && b(a[0])
            }

            function H(a, b, c) {
                !1 === b || a[0].isProcessing ? J(a, c) : a.trigger("sorton", [a[0].config.sortList, function() {
                    J(a, c)
                }])
            }
            ...
            function K(a) {
                var b = a.config,
                    c = b.$table;
                c.unbind("sortReset update updateRows updateCell updateAll addRows sorton appendCache updateCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave ".split(" ").join(".tablesorter ")).bind("sortReset.tablesorter", function(c) {
                    c.stopPropagation();
                    b.sortList = [];
                    F(a);
                    I(a);
                    A(a)
                }).bind("updateAll.tablesorter", function(c, e, d) {
                    c.stopPropagation();
                    ...
                    K(a);
                    B(a, e, d)
                }).bind("update.tablesorter updateRows.tablesorter", function(b, c, d) {
                    b.stopPropagation();
                    G(a);
                    B(a, c, d)
                }).bind("updateCell.tablesorter", function(h, e, d, f) {
                    h.stopPropagation();
                    ...
                    e = g(e)[0];
                    n.length && 0 <= h && (q = n.eq(h).find("tr").index(m), l = e.cellIndex, n = b.cache[h].normalized[q].length - 1, b.cache[h].row[a.config.cache[h].normalized[q][n]] = m, b.cache[h].normalized[q][l] = b.parsers[l].format(p(a, e, l), a, e, l), H(c, d, f))
                }).bind("addRows.tablesorter", function(h, e, d, f) {
                    h.stopPropagation();
                    if (m(b.cache)) G(a), B(a, d, f);
                    else {
                        var g, q = e.filter("tr").length,
                            l = [],
                            u = e[0].cells.length,
                            v = c.find("tbody").index(e.parents("tbody").filter(":first"));
                        b.parsers || s(a);
                        for (h = 0; h < q; h++) {
                            for (g = 0; g < u; g++) l[g] = b.parsers[g].format(p(a, e[h].cells[g], g), a, e[h].cells[g], g);
                ...
                }).bind("sorton.tablesorter", function(b, e, d, f) {
                    var g = a.config;
                    b.stopPropagation();
                ...
                }).bind("updateCache.tablesorter", function(c, e) {
                    b.parsers || s(a);
                    v(a);
                    "function" === typeof e && e(a)
                }).bind("applyWidgetId.tablesorter", function(c, e) {
                    c.stopPropagation();
            ...
            f.setup = function(a, b) {
                ...
                b.$table = h.addClass(f.css.table + " " + b.tableClass + c).attr({
                    role: "grid"
                });
                b.$tbodies = h.children("tbody:not(." + b.cssInfoBlock + ")").attr({
                    "aria-live": "polite",
                    "aria-relevant": "all"
                });
                ...
                f.applyWidget(a, !0);
                0 < b.sortList.length ? h.trigger("sorton", [b.sortList, {}, !b.initWidgets]) : (F(a), b.initWidgets && f.applyWidget(a));
            ...
            f.isProcessing = function(a, b, c) {
                ...
                b ? ("undefined" !== typeof c && 0 < h.sortList.length && (a = a.filter(function() {
                    return this.sortDisabled ? !1 : f.isValueInArray(parseFloat(g(this).attr("data-column")), h.sortList)
                })), a.addClass(f.css.processing + " " + h.cssProcessing)) : a.removeClass(f.css.processing + " " + h.cssProcessing)
            };
            f.processTbody = function(a, b, c) {
                a = g(a)[0];
                if (c) return a.isProcessing = !0, b.before('<span class="tablesorter-savemyplace"/>'), c = g.fn.detach ? b.detach() : b.remove();
            ...
            f.bindEvents = function(a, b) {
                a = g(a)[0];
                var c, h = a.config;
                b.find(h.selectorSort).add(b.filter(h.selectorSort)).unbind("mousedown.tablesorter mouseup.tablesorter sort.tablesorter keyup.tablesorter").bind("mousedown.tablesorter mouseup.tablesorter sort.tablesorter keyup.tablesorter", function(e, d) {
                    var f;
                    f = e.type;
                    if (!(1 !== (e.which || e.button) && !/sort|keyup/.test(f) || "keyup" === f && 13 !== e.which || "mouseup" === f && !0 !== d && 250 < (new Date).getTime() - c)) {
                        if ("mousedown" === f) return c = (new Date).getTime(), "INPUT" === e.target.tagName ? "" : !h.cancelSelection;
                ...
                h.cancelSelection && b.attr("unselectable", "on").bind("selectstart", !1).css({
                    "user-select": "none",
                    MozUserSelect: "none"
                })
            };
            ...
            f.destroy = function(a, b, c) {
                ...
                if (a.hasInitialized) {
                    ...
                    var h = g(a),
                        e = a.config,
                        d = h.find("thead:first"),
                        k = d.find("tr." + f.css.headerRow).removeClass(f.css.headerRow + " " + e.cssHeaderRow),
                        n = h.find("tfoot:first > tr").children("th, td");
                    d.find("tr").not(k).remove();
                    h.removeData("tablesorter").unbind("sortReset update updateAll updateRows updateCell addRows sorton appendCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave keypress sortBegin sortEnd ".split(" ").join(".tablesorter "));
                    ...
                    k.find(e.selectorSort).unbind("mousedown.tablesorter mouseup.tablesorter keypress.tablesorter");
                    f.restoreHeaders(a);
            ...
            f.sortNatural = function(a, b) {
                ...
                h = f.regex;
                if (h.hex.test(b)) {
                    c = parseInt(a.match(h.hex), 16);
                    e = parseInt(b.match(h.hex), 16);
                    if (c < e) return -1;
                    if (c > e) return 1
                }
                c = a.replace(h.chunk, "\\0$1\\0").replace(/\\0$/, "").replace(/^\\0/, "").split("\\0");
                h = b.replace(h.chunk, "\\0$1\\0").replace(/\\0$/, "").replace(/^\\0/, "").split("\\0");
                n = Math.max(c.length, h.length);
                for (g = 0; g < n; g++) {
                    e = isNaN(c[g]) ? c[g] || 0 : parseFloat(c[g]) || 0;
                    d = isNaN(h[g]) ? h[g] || 0 : parseFloat(h[g]) || 0;
            ...
            f.replaceAccents = function(a) {
                ...
                if (!f.characterRegex) {
                    ...
                    for (b in d) "string" === typeof b && (c += d[b], f.characterRegexArray[b] = RegExp("[" + d[b] + "]", "g"));
            ...
            f.applyWidget = function(a, b) {
                ...
                c.widgets.length && (c.widgets = g.grep(c.widgets, function(a, b) {
                    ...
                    if (f) {
                        if (b || !c.widgetInit[f.id]) f.hasOwnProperty("options") && (d = a.config.widgetOptions = g.extend(!0, {}, f.options, d)), f.hasOwnProperty("init") && f.init(a, f, c, d), c.widgetInit[f.id] = !0;
                        !b && f.hasOwnProperty("format") && f.format(a, c, d, !1)
                    }
                }));
                c.debug && (k = c.widgets.length, u("Completed " + (!0 === b ? "initializing " : "applying ") + k + " widget" + (1 !== k ? "s" : ""), m))
            };
            f.refreshWidgets = function(a, b, c) {
                ...
                var h, e = a.config,
                    ...
                    k = f.widgets,
                    n = k.length;
                for (h = 0; h < n; h++) k[h] && k[h].id && (b || 0 > g.inArray(k[h].id, m)) && (e.debug && d('Refeshing widgets: Removing "' + k[h].id + '"'), k[h].hasOwnProperty("remove") && e.widgetInit[k[h].id] && (k[h].remove(a, e, e.widgetOptions), e.widgetInit[k[h].id] = !1));
    ...
    p.addParser({
        ...
        format: function(d, u) {
            var m = u.config;
            d && (d = g.trim(m.ignoreCase ? d.toLocaleLowerCase() : d), d = m.sortLocaleCompare ? p.replaceAccents(d) : d);
            return d
        },
        type: "text"
    });
    p.addParser({
        ...
        format: function(d, u) {
            var m = p.formatFloat((d || "").replace(/[^\w,. \-()]/g, ""), u);
            return d && "number" === typeof m ? m : d ? g.trim(d && u.config.ignoreCase ? d.toLocaleLowerCase() : d) : d
        },
        type: "numeric"
    });
    p.addParser({
    ...
    p.addParser({
        ...
        format: function(d, g) {
            var m, t = d ? d.split(".") : "",
                s = "",
                v = t.length;
            for (m = 0; m < v; m++) s += ("00" + t[m]).slice(-3);
    ...
    p.addParser({
        ...
        format: function(d, g) {
            return d ? p.formatFloat("" !== d ? (new Date(d.replace(/-/g, "/"))).getTime() || "" : "", g) : d
        },
        type: "numeric"
    });
    p.addParser({
    ...
    p.addParser({
        ...
        format: function(d, g) {
            return d ? p.formatFloat((new Date(d.replace(/(\S)([AP]M)$/i, "$1 $2"))).getTime() || "", g) : d
        },
        type: "numeric"
    });
    p.addParser({
        ...
        format: function(d, g, m, t) {
            if (d) {
                m = g.config;
                var s = m.$headers.filter("[data-column=" + t + "]:last");
                t = s.length && s[0].dateFormat || p.getData(s, m.headers[t], "dateFormat") || m.dateFormat;
                d = d.replace(/\s+/g, " ").replace(/[\-.,]/g, "/");
                "mmddyyyy" === t ? d = d.replace(/(\d{1,2})[\/\s](\d{1,2})[\/\s](\d{4})/, "$3/$1/$2") : "ddmmyyyy" === t ? d = d.replace(/(\d{1,2})[\/\s](\d{1,2})[\/\s](\d{4})/, "$3/$2/$1") : "yyyymmdd" === t && (d = d.replace(/(\d{4})[\/\s](\d{1,2})[\/\s](\d{1,2})/, "$1/$2/$3"))
            }
            return d ? p.formatFloat((new Date(d)).getTime() || "", g) : d
        },
        type: "numeric"
    });
    p.addParser({
        ...
        format: function(d, g) {
            return d ? p.formatFloat((new Date("2000/01/01 " + d.replace(/(\S)([AP]M)$/i, "$1 $2"))).getTime() || "", g) : d
        },
        type: "numeric"
    });
    p.addParser({
    ...
    p.addWidget({
        id: "zebra",
        priority: 90,
        format: function(d, u, m) {
            var t, s, v, A, D, C, E = RegExp(u.cssChildRow, "i"),
                B = u.$tbodies;
            u.debug && (D = new Date);
            for (d = 0; d < B.length; d++) t = B.eq(d), C = t.children("tr").length, 1 < C && (v = 0, t = t.children("tr:visible").not(u.selectorRemove), t.each(function() {
                s = g(this);
                E.test(this.className) || v++;
                A = 0 === v % 2;
                s.removeClass(m.zebra[A ? 1 : 0]).addClass(m.zebra[A ? 0 : 1])
            }));
            u.debug && p.benchmark("Applying Zebra widget", D)
        },
        remove: function(d, p, m) {
            var t;
            p = p.$tbodies;
            var s = (m.zebra || ["even", "odd"]).join(" ");
            for (m = 0; m < p.length; m++) t = g.tablesorter.processTbody(d, p.eq(m), !0), t.children().removeClass(s), g.tablesorter.processTbody(d, t, !1)
        }
    })
}(jQuery);
    ...
    .then((data) => {
      ...
      if (active === "true" && globalSet !== "true") {
        ...
        globalNotification.innerHTML =
          '<div class="hse-notification-banner__container hse-width-container"><div class="hse-notification-banner__text hse-u-reading-width">' +
          message +
          "</div>" +
          '<div class="hse-notification-banner__button"><button class="notification-hide hse-button hse-button--small hse-button--transparent">Hide&nbsp;message</button></a></div>';

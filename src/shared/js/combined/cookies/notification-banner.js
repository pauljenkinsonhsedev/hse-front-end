...
export function notificationBanner() {
    ...
    .then((data) => {
        ...
        if (active === 'true' && globalSet !== 'true') {
            ...
            globalNotification.innerHTML = '<div class="notification-container fixed-container">' + message + '<button class="notification-hide btn btn-small btn-yellow">Hide&nbsp;message</a></button>';

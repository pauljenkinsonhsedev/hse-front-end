...
const decodedEssential = window.atob(encodedEssential);
...
if (!cookieExists) {	
	Cookies.set(cookiePolicy, encodedEssential , { sameSite: 'strict' }, { path: '' }, { expires: 365})
}
...
$('#acceptAllCookies').click(function() {
 ...
 Cookies.set(cookiePolicy, encodedApproved , { sameSite: 'strict' }, { path: '' }, { expires: 365})
 Cookies.set(cookiePreferences, true , { sameSite: 'strict' }, { path: '' }, { expires: 365})

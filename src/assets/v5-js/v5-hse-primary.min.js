...
if (!cookieExists) {	
	Cookies.set(cookiePolicy, encodedEssential , { path: '/' , domain: '.hse.gov.uk', sameSite: 'None', secure: true, expires: 365})
}
...
$('#acceptAllCookies').click(function() {
 ...
 Cookies.set(cookiePolicy, encodedApproved , { path: '/', domain: '.hse.gov.uk', sameSite: 'None', secure: true,  expires: 365})

...
$(document).ready(function(){$(".homepageSlider").show();$(".homepageSlider").royalSlider({keyboardNavEnabled:!0,controlNavigation:"tabs",slidesSpacing:0,loop:!0,transitionSpeed:400,autoPlay:{enabled:!0,pauseOnHover:!0,delay:5E3}});var b=$(".homepageSlider").data("royalSlider");$(".sliderControl").addClass("sliderOn");$(".sliderControl").html('<img src="'+platformPath+'/assets/v4-homepage/slider/pause-icon.png" alt="Pause slider" />');$(".sliderControl").click(function(a){a.preventDefault();$(".sliderControl").hasClass("sliderOn")? (b.stopAutoPlay(),$(this).html('<img src="'+platformPath+'/assets/v4-homepage/slider/play-icon.png" alt="Resume slider" />').removeClass("sliderOn").addClass("sliderOff")):(b.startAutoPlay(),$(this).html('<img src="'+platformPath+'/assets/v4-homepage/slider/pause-icon.png" alt="Pause slider" />').removeClass("sliderOff").addClass("sliderOn"))});jQuery(function(a){a("#homepageCarousel").touchCarousel({useWebkit3d:!0})});$(function(){window.PIE&&$(".homepageNews ul li img, .touchcarousel-item img, .sliderControl").each(function(){PIE.attach(this)})})});
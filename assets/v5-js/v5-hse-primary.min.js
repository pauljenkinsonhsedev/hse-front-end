...
var cookieCheck = Cookies.get('cookiePolicy');
var cookiePrefCheck = Cookies.get('cookies_preferences_set');


// Set esscookieCheck = Cookies. cookies_policy does not exist

const cookieExists = Cookies.get('cookies_policy');

if (!cookieExists) {
	document.cookie = cookiePolicy + "=" + JSON.stringify(essential_cookie_consent) + ";" + "expires=Thu, 18 Dec 2020 12:00:00 UTC" + ";" + " path=/";
}
...
$('#acceptAllCookies').click(function() {
 ...
 document.cookie = cookiePolicy + "=" + JSON.stringify(approved_all_cookie_consent) + ";" + "expires=Thu, 18 Dec 2020 12:00:00 UTC" + ";" + " path=/";
